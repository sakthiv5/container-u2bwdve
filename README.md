...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-u2bwdve.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-u2bwdve.containers.anotherwebservice.com/
...
```
git clone git@github.com:sakthiv5/container-u2bwdve.git
cd container-u2bwdve
```
...
```
docker attach container-u2bwdve
```
